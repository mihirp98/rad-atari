...
import sacd.agent.rad_utils as rad_utils
...
class BaseAgent(ABC):
    ...
    def __init__(self, env, test_env, log_dir, num_steps=100000, batch_size=64,
                 ...
                 log_interval=10, eval_interval=1000, cuda=True, seed=0, rad_flag = False):
        super().__init__()
        self.env = env
        ...
        if rad_flag:
            self.memory = rad_utils.ReplayBuffer(
